...
const Problem2 = () => {
  ...
  useEffect(() => {
    axios.get("https://contact.mediusware.com/api/contacts/").then((res) => {
      ...
      setUsCountry(searchedUsCountry);
  ...
  const handleSearchUs = () => {
    ...
    setUsCountry(searchedCountry.length > 0 ? searchedCountry : allUsCountry);
    setSearchQueryUs("");
  };
  ...
  const filteredCountryUsList = eventStatusUs
    ? usCountry.filter((country) => country.id % 2 === 0)
    : usCountry;
  ...
  //----find single country info for modal  end----------
          ...
          <div className="modal-content">
            ...
            <div className="modal-footer justify-content-between align-items-center">
              <div className="form-check">
                <input
                  onChange={() => setEvenStatus(!eventStatus)}
            ...
            <div className="modal-footer justify-content-between align-items-center">
              <div className="form-check">
                <input
                  ...
                  value=""
                  id="flexCheckIndeterminate"
                  onChange={() => setEvenStatusUs(!eventStatusUs)}
